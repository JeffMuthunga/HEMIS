...
function ProductHeader() {
	...
	const [createProduct] = useCreateResearchProductMutation();
	const [saveProduct] = useUpdateResearchProductMutation();
	const [removeProduct] = useDeleteResearchProductMutation();
	...
	// const { name, images, featuredImageId } = watch() as ResearchProduct;

	function handleSaveProduct() {
		saveProduct(getValues() as ResearchProduct);
	}

	function handleCreateProduct() {
		createProduct(getValues() as ResearchProduct)
			.unwrap()
			.then((data) => {
