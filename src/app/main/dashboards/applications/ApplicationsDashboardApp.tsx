...
import ApplicationsDashboardAppHeader from './ApplicationsDashboardAppHeader';
...
import Institutions from './applications_tables/Applications';
...
function ApplicationsDashboardApp() {
	return (
		<FusePageSimple
			header={<ApplicationsDashboardAppHeader />}
			content={
				<motion.div
...
export default ApplicationsDashboardApp;
