...
function ProgrammeHeader() {
	...
	const [createProduct] = useCreateProgrammeMutation();
	const [saveProduct] = useUpdateProgrammeMutation();
	const [removeProduct] = useDeleteProgrammeMutation();
	...
	function handleRemoveProduct() {
		...
		navigate('/dashboards/programmes/programmes');
	}
