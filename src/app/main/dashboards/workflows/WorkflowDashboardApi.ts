...
const WorkflowDashboardApi = api
	.enhanceEndpoints({
		addTagTypes
	})
	.injectEndpoints({
...
export default WorkflowDashboardApi;
...
export const { useGetProjectDashboardWidgetsQuery, useGetProjectDashboardProjectsQuery } = WorkflowDashboardApi;

export type ProjectDashboardApiType = {
	[WorkflowDashboardApi.reducerPath]: ReturnType<typeof WorkflowDashboardApi.reducer>;
};
...
declare module 'app/store/lazyLoadedSlices' {
	export interface LazyLoadedSlices extends WithSlice<typeof WorkflowDashboardApi> {}
}

export const selectProjectDashboardWidgets = createSelector(
	WorkflowDashboardApi.endpoints.getProjectDashboardWidgets.select(),
