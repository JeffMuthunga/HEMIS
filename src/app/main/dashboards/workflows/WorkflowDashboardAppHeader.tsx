...
import { useGetProjectDashboardProjectsQuery } from './WorkflowDashboardApi';

/**
 * The ProjectDashboardAppHeader page.
 */
function WorkflowDashboardAppHeader() {
			...
			<div className="flex flex-col sm:flex-row flex-auto sm:items-center min-w-0 my-32 sm:my-48">
				<div className="flex flex-auto items-start min-w-0">
					...
					<div className="flex flex-col min-w-0 mx-16">
						...
						>
							Your hub for tracking and managing tasks effortlessly.
						</Typography>
...
export default WorkflowDashboardAppHeader;
