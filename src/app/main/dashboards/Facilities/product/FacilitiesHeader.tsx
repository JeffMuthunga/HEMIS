...
function ProductHeader() {
	...
	const [createProduct] = useCreateFacilitiesProductMutation();
	const [saveProduct] = useUpdateFacilitiesProductMutation();
	const [removeProduct] = useDeleteFacilitiesProductMutation();
	...
	const { name, images, featuredImageId } = watch() as FacilitiesProduct;

	function handleSaveProduct() {
		saveProduct(getValues() as FacilitiesProduct);
	}

	function handleCreateProduct() {
		createProduct(getValues() as FacilitiesProduct)
			.unwrap()
			.then((data) => {
