		...
		<div className="flex grow-0  flex-1 w-full items-center justify-between  space-y-8 sm:space-y-0 py-24 sm:py-32">
			...
			>
				<div>
					...
					<Typography className="text-4xl font-extrabold leading-none tracking-tight">Accreditations</Typography>
				</div>
			</motion.span>
...
export default AccreditationsHeader;
