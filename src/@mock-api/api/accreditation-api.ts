...
import AccreditationsApi, {Accreditation} from "../../app/main/dashboards/accreditations/AccreditationsApi";

let accreditationsDB = accreditationsMockApi.accreditations.value as Accreditation[];
